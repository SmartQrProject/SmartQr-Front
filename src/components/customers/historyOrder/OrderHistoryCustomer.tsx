...
const OrderHistory: React.FC = () => {
  ...
  const activeStatuses = ["pending", "in-process", "ready"];
  ...
  console.log("hActsive Orders:", recentlyCompletedOrders);
      ...
      <div className="mt-3">
        ...
        <ul className="divide-y divide-gray-200 border border-gray-200 rounded-md">
          {order.items.map((item, index) => (
            <li
              key={index}
              className="flex justify-between px-4 py-2 text-gray-700"
            >
      ...
      <div className="max-w-6xl mx-auto flex flex-col gap-10">
        <section>
          ...
          {/* {recentlyCompletedOrders.length > 0 && (
            ...
            //   {/* Please note that it may take up to one hour for your orders to
