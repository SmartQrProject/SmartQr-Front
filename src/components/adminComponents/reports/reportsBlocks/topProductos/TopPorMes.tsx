...
const TopPorMes = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        console.error("Error al obtener top productos del mes:", err);
      } finally {
        setLoading(false);
      }
    };
  ...
  return (
    <div className="bg-white p-4 rounded-xl border shadow-sm">
      <h3 className="text-lg font-semibold mb-4">Top productos del mes</h3>
      ...
      {loading ? (
        ...
        <p>No hubo productos vendidos este mes.</p>
      ) : (
