...
const FrecuenciaPorSemana = () => {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                const res = await fetch(`${APIURL}/${slug}/reports/sales-frequency?group=weekday`, {
    ...
    const xTickFontSize = screenWidth !== null && screenWidth < 480 ? 11 : 13;

    return (
        <div className="bg-white p-4 sm:p-6 rounded-xl shadow-md w-full mb-6">
            <h3 className="text-lg sm:text-xl font-bold mb-4 text-center sm:text-left">Weekly Sales Frequency</h3>
            ...
            {loading ? (
                ...
                <p className="text-sm text-gray-500 text-center">No sales data by day of week.</p>
            ) : (
