...
const ClientesNuevosPorMes = () => {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                const res = await fetch(`${APIURL}/${slug}/reports/customers?sortBy=createdAt&order=asc&limit=1000&page=1`, {
        ...
        <div className="bg-white p-4 sm:p-6 rounded-xl w-full mb-6">
            ...
            {loading ? (
                <div className="flex gap-4 justify-center items-center h-40">
                    <p className="text-sm md:text-lg text-branding-900">Loading Data...</p>
