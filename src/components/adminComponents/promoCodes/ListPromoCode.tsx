            ...
            {activeCodes.length === 0 ? (
              ...
              <ul className="space-y-2 mt-2">
                {activeCodes.map((promo) => (
                  <li
                    key={promo.id}
                    className="border border-green-300 bg-green-50 text-green-800 px-4 py-2 rounded-md flex justify-between items-center"
                  >
                    <div>
            ...
            {inactiveCodes.length === 0 ? (
              ...
              <ul className="space-y-2 mt-2">
                {inactiveCodes.map((promo) => (
                  <li
                    key={promo.id}
                    className="border border-red-300 bg-red-50 text-red-800 px-4 py-2 rounded-md flex justify-between items-center"
                  >
                    <div>
                      <strong >{promo.code}</strong>
                      </div>  
