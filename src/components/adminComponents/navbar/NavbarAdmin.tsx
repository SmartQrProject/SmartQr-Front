            ...
            <nav className="m-5">
                <div className="flex justify-between items-center">
                    <Link className="text-[#6494ED] font-bold text-xl " href={"/"}>
                        <>
                            <img src={`https://res.cloudinary.com/${cloudName}/image/upload/logo2_jzvw9b.png`} alt="SmartQR" className="h-16 inline-block rounded-lg" />
                        </>
                    </Link>
                    ...
                    <div className="hidden sm:flex items-center space-x-4">
                        <Link className="py-2 px-4 rounded-3xl border border-transparent hover:bg-[#9CA3AF] hover:border-white flex items-center" href={"/dashboard/gethelp"}>
                ...
                {open && (
                    <div className="sm:hidden fixed top-0 right-0 h-screen w-50 bg-white shadow-lg z-50 p-6 transition-transform duration-300 ease-in-out">
                        ...
                        <div className="flex flex-col space-y-2">
                            <Link className="py-1 px-4 rounded-3xl hover:bg-gray-300 w-30" href={"/dashboard/gethelp"}>
                                Get Help
                            </Link>
