...
const Table: React.FC<TableProps> = ({
  ...
  return (
    <div
      className={`relative rounded-xl p-4 w-[260px] shadow-md ${
      ...
      <div className="flex flex-col items-center justify-center h-full gap-2 pt-4">
        ...
        <div className="flex gap-2 mt-2">
          <button
            ...
            className="text-md text-default-900 font-semibold  hover:text-blue-600 cursor-pointer "
          >
            <Download/>
          </button>
          <button
            onClick={handlePrint}
            className="text-md text-default-900 font-semibold  hover:text-green-600 cursor-pointer"
          >
            <Printer/>
          </button>
        </div>
