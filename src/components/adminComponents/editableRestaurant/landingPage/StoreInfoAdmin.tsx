...
import EditableStoreInfoModal from './EditableStoreInfo';
import { getRestaurantWithMenu } from '@/helper/restaurantsSlugFetch';
import { IRestaurant } from '@/types';
import MapRenderer from '../../maps/MapRenderer';
import { getCoordsFromAddress } from '../../maps/GeocodificarCoordFromAddress';
...
const StoreInfoModal = ({ open, onClose, slug }: StoreInfoModalProps) => {
        ...
        <div className="relative w-full max-w-xl rounded-xl p-6 mx-4 border border-gray-300 bg-white shadow-lg overflow-y-auto">
          <div className="absolute top-3 right-3 flex gap-2">
            <button
              ...
              className="text-gray-900 hover:text-sky-600 cursor-pointer"
              aria-label="Edit"
            >
