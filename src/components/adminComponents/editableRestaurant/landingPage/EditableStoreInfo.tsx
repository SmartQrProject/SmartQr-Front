        ...
        <div className="flex flex-col md:flex-row gap-4 mb-4">
          ...
          <div className="flex-1 flex flex-col space-y-4">
            ...
            <div className="flex flex-col w-full max-w-xl">
              ...
              <textarea value={tags} onChange={(e) => setTags(e.target.value)} placeholder="Separate tags with commas, e.g. Italian, Pizza, Vegan" className="w-full p-2 rounded-md min-h-[100px] resize-none bg-gray-300 text-sm" />
            </div>

            <div className="flex flex-col w-full max-w-xl">
              <label className="text-md font-semibold mb-2">Description</label>
              <textarea value={description} onChange={(e) => setDescription(e.target.value)} className="text-sm w-full p-2 rounded-md min-h-[100px] resize-none bg-gray-300 " />
            </div>
